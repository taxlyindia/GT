...
async def serve_frontend(full_path: str):
    ...
    API paths are explicitly excluded so this never shadows /api/* routes,
    which would cause 405 Method Not Allowed on POST/PUT/DELETE requests.
    """
    # Never intercept API routes — let FastAPI's router handle them normally
